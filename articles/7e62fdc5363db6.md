...
emoji: "🎋"
type: "tech"
topics: ["security", "writeup", "cybersecurity", "hacking", "hackthebox"]
published: true
---
...
[windapsearch](https://github.com/ropnop/go-windapsearch) で匿名バインドを活用した情報列挙を実施する。
...
[Impacket](https://salsa.debian.org/python-team/packages/impacket) という攻撃ツール群のようなものがあり、このうちの一つ。
...
PWハッシュを取得出来たので、[john](https://gitlab.com/kalilinux/packages/john) を使用して解析する。
...
取得したID/PWを使用し、[evil-winrm](https://gitlab.com/kalilinux/packages/evil-winrm) でログインする。
...
[SharpHound](https://bloodhound.specterops.io/collect-data/ce-collection/sharphound) を攻撃端末（Kali）から被害端末（svc-alfresco）へ移動させる。
...
[BloodHound](https://bloodhound.specterops.io/get-started/quickstart/community-edition-quickstart) へZipをアップロード
